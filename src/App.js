		...
		<ThemeProvider theme={mainColor}>
			<div className="App">
				<Routes>
					...
					<Route
						path="/nonprofits"
						element={<SearchNonProfits orgs={orgs} setSelectedOrg={setSelectedOrg} />}
					/>
					...
					<Route path="/non-profit" element={<NonProfit selectedOrg={selectedOrg} />} />
					<Route path="/non-project" element={<NonProfitProject selectedOrg={selectedOrg} />} />
					{/* <Route
            path="/nonprofithome"
